...
Responses are recorded on the stinger response sheet.

## Stinger Deck

<div class="presentation-embed">
  <iframe class="presentation-embed-fill" src="https://docs.google.com/presentation/d/123vh6uuGyw5sT6x9kd9CVoNZKu0Vmqo5CE66_hOCEW0/embed?start=false&loop=false&delayms=3000&slide=id.p10" allowfullscreen loading="lazy"></iframe>
</div>

## Stinger Response Sheet

<div class="worksheet-card">
  <a href="{{ '/assets/downloads/stinger-response-sheet.pdf' | relative_url }}" target="_blank" class="worksheet-preview-link">
    <img class="worksheet-preview" src="{{ '/assets/downloads/stinger-response-sheet-preview.png' | relative_url }}" alt="Preview of the Stinger Response Sheet">
  </a>
