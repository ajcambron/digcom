**Keying**
: Removing a specific color or brightness value from a shot to make it transparent, usually to
...
**Ultra Key**
: Premiere's primary chroma keying effect, with controls for key color, matte generation, and
spill suppression.
