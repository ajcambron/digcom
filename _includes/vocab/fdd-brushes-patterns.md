...
**Generate Pattern**
: A live pattern-making mode (Object > Pattern > Make) that previews your artwork tiled across
the canvas as you build it, letting you adjust tile type, spacing, and overlap before saving the
result as a swatch.
