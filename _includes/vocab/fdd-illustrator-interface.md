...
tool's or feature's full set of options. Panels can be docked into the side column, floated
freely, grouped together as tabs, or closed when not needed.

**Toolbars**
: The column of tool icons (Selection, Pen, Shape tools, and more) along the side of the window.
A small triangle on a tool's icon means it's hiding a flyout group of related tools.
