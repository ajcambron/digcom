**Copyright**
: Automatic legal protection, granted the moment an original work is fixed in a tangible form
(saved, drawn, written), giving the creator exclusive rights to reproduce, distribute, and adapt
their work.
...
**Derivative Work**
: A new work based on or adapted from an existing copyrighted work (a redrawn logo, a remixed
illustration). Creating one generally requires the original copyright holder's permission, even
if the new version looks quite different from the source.
...
**Usage Rights**
: The specific permissions a license grants for how a work may be used: where, for how long, in
what medium, and for what purpose. Separate from who owns the copyright itself.
