...
**Pencil Tool**
: A freehand drawing tool for sketchy, natural-feeling paths, drawn by dragging the cursor like a
pencil on paper.

**Paintbrush Tool**
: Draws a path with a chosen brush style (calligraphic, scatter, art, bristle, or pattern) applied
along it.
...
**Line Segment Tool**
: Draws a single straight line segment by clicking and dragging, or by clicking once to open a
dialog for a precise length and angle.
