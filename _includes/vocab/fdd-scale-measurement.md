...
**Actual Size**
: The true, real-world dimensions of an object or space, as opposed to its scaled representation
on paper or screen.

**Scale Ruler**
: A specialized ruler with several sets of graduated markings, each corresponding to a different
scale ratio, used to measure or draw at scale without doing the math by hand for every
measurement.

**Scale Factor**
: The single number a real measurement is multiplied (or divided) by to convert it to its scaled
