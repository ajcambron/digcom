...
settling on the first workable one.
...
generating original ideas, so new work is informed rather than working from a blank memory.

**Mood Board**
: A collected arrangement of images, colors, textures, and type samples used to establish and
communicate the intended look and feel of a project before production begins.

**Thumbnail**
: A small, fast, rough sketch used during ideation to quickly try out many compositional ideas
without investing time in any one of them.
