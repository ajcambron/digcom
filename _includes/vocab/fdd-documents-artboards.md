...
holding area, but nothing on the pasteboard ever prints or exports.

**Bleed**
: Extra artwork extended past an artboard's trim edge, so that no thin white sliver appears along
...
from being cut off if the trim shifts slightly.
