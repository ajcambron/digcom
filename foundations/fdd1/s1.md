...
done entirely on paper, since network/computer access is unreliable this early in the year. Do
all four rounds below (Line, Shape, Texture, Color) on paper first; you'll only need a phone or
tablet to photograph your finished roughs at the end of each round for your portfolio.
...
* Photograph your roughs for your portfolio.
...
Go through the Design revision process to create an abstract composition based on the element of texture.
...
Go through the Design revision process to create an abstract composition based on the element of color.
