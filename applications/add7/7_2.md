---
layout: default
title: 7.2 | Camera Moves, Camera Angles, Framing, Exposure
parent: ADD | Unit 7
...
### Aperture
[Aperture](https://en.wikipedia.org/wiki/Aperture) refers to the opening that allows light to enter the camera body. It is measured using [f-numbers](https://en.wikipedia.org/wiki/F-number) which refer to the [Focal_length](https://en.wikipedia.org/wiki/Focal_length) divided by the diameter of the [entrance pupil](https://en.wikipedia.org/wiki/Entrance_pupil). As the f-Number increases, so does the amount of light that enters the camera.
...
### Gain
Originally described as "film speed" gain is the setting on digital cameras that is an attempt to measure the sensor's sensitivity to light. Digital Cameras usually describe this as [ISO or Gain](https://en.wikipedia.org/wiki/Film_speed#Digital_camera_ISO_speed_and_exposure_index)

## Setting Exposure on the Rebel T6
[Video Overview of Exposure Settings](https://www.youtube.com/watch?app=desktop&v=6SPgPOH21S8)
